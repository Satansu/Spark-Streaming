...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             .appName("RealTimeProject")
             .config('spark.jars.packages', 'org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.0')
             .config('spark.jars', "file:///C:/Users/Satansu/PycharmProjects/pythonProject1/postgresql-42.7.1.jar")
    ...
    votes_per_candidate_to_kafka = (votes_per_candidate.selectExpr('to_json(struct(*)) AS value')
                                    ...
                                    .option('CheckpointLocation', 'file:///C:/Users/Satansu/PycharmProjects/pythonProject1'
    ...
    turnout_by_location_to_kafka = (turnout_by_location.selectExpr('to_json(struct(*)) AS value')
                                    ...
                                    .option('kafka.bootstrap.servers', 'localhost:9092')
                                    .option('topic', 'aggregated_votes_per_candidate')
                                    .option('CheckpointLocation', 'file:///C:/Users/Satansu/PycharmProjects'
                                                                  '/pythonProject1/checkpoints/checkpoint2')
                                    .outputMode('update')
                                    .start()
                                    )
